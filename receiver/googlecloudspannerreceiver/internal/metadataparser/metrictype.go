...
func (metricType MetricType) dataType() (pdata.MetricDataType, error) {
	...
	default:
		return pdata.MetricDataTypeNone, fmt.Errorf("invalid data type received")
	}

	return dataType, nil
}

func (metricType MetricType) aggregationTemporality() (pdata.AggregationTemporality, error) {
	var aggregationTemporality pdata.AggregationTemporality

	switch metricType.Aggregation {
	case aggregationTemporalityDelta:
		aggregationTemporality = pdata.AggregationTemporalityDelta
	case aggregationTemporalityCumulative:
		aggregationTemporality = pdata.AggregationTemporalityCumulative
	case "":
		aggregationTemporality = pdata.AggregationTemporalityUnspecified
	default:
		return pdata.AggregationTemporalityUnspecified, fmt.Errorf("invalid aggregation temporality received")
	}
