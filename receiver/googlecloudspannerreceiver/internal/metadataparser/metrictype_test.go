...
func TestAggregationTemporality(t *testing.T) {
	testCases := map[string]struct {
		...
		expectedAggregationTemporality pdata.AggregationTemporality
		expectError                    bool
	}{
		"Cumulative": {aggregationTemporalityCumulative, pdata.AggregationTemporalityCumulative, false},
		"Delta":      {aggregationTemporalityDelta, pdata.AggregationTemporalityDelta, false},
		"Empty":      {"", pdata.AggregationTemporalityUnspecified, false},
		"Invalid":    {"invalid", pdata.AggregationTemporalityUnspecified, true},
	}
...
func TestToMetricDataType(t *testing.T) {
	testCases := map[string]struct {
		...
		"Happy path":          {metricDataTypeGauge, aggregationTemporalityCumulative, pdata.MetricDataTypeGauge, pdata.AggregationTemporalityCumulative, true, false},
		"Invalid data type":   {"invalid", aggregationTemporalityCumulative, pdata.MetricDataTypeNone, pdata.AggregationTemporalityCumulative, true, true},
		"Invalid aggregation": {metricDataTypeGauge, "invalid", pdata.MetricDataTypeGauge, pdata.AggregationTemporalityUnspecified, true, true},
	}
