...
func group(dataPoints []*MetricsDataPoint) map[MetricsDataPointGroupingKey][]*MetricsDataPoint {
	var groupedDataPoints map[MetricsDataPointGroupingKey][]*MetricsDataPoint

	if len(dataPoints) > 0 {
		groupedDataPoints = make(map[MetricsDataPointGroupingKey][]*MetricsDataPoint)
