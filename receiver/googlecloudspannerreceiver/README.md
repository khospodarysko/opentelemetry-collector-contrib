...
- **collection_interval** - this receiver runs on an interval. Each time it runs, it queries Google Cloud Spanner, creates metrics and sends them to the next consumer
- **top_metrics_query_max_rows** - max number of rows to fetch from Top N built-in table
- **projects** - list of GCP projects
    ...
    - **instances** - list of Google Cloud Spanner instance for connection
        - **id** - identifier of Google Cloud Spanner instance
